...
| D-043 | 01/08/2026 | 14 | Retrait de la gestion des contrats et des paiements (création/modification/clôture) des droits du Gestionnaire locatif — qui les reprend ? | Le Gestionnaire locatif perd la création, la modification et la clôture des contrats ainsi que l'enregistrement des paiements ; il garde la consultation (lecture seule) de ces deux modules. Le Gérant et l'Administrateur reprennent conjointement la création/modification/clôture des contrats et l'enregistrement des paiements. La validation d'un contrat et la correction d'un paiement restent réservées au seul Gérant (non demandé, inchangé) — un contrat créé par le Gérant peut donc être validé par ce même Gérant (perte de la séparation des tâches créateur/validateur qui existait avec le Gestionnaire ; signalé, non bloquant, à la demande explicite du client) | Section 04 (acteurs), section 14 (matrice §14.1) |
| D-044 | 01/08/2026 | 13 | Reçu de caution imprimable — quelle portée (document absent du CDC) ? | Reçu de versement à la signature du contrat uniquement (montant initial, date de versement) — pas de reçu de remboursement/retenue à la sortie, déjà couvert par le suivi des cautions et le rapport « État des cautions ». Accès en lecture identique au suivi des cautions (tous profils) | Section 13 (états et rapports) |
